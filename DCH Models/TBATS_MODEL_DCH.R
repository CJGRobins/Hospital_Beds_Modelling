...
midnight_beds_dch_tbats_list <- midnight_beds_dch %>%
  select(-`Census Date`) %>%
  group_by(Discharge_Main_Specialty_Desc) %>%
  nest()

midnight_beds_dch_tbats_7 <- midnight_beds_dch_tbats_list %>%
...
midnight_beds_dch_tbats_fit <-
  midnight_beds_dch_tbats_7 %>%
  mutate(fit.tbats = map(data_train_7.ts, tbats))

midnight_beds_dch_tbats_forecast <-
  midnight_beds_dch_tbats_fit %>%
  mutate(forecast.tbats = map(fit.tbats, forecast, h = 60))

midnight_beds_dch_tbats_forecast_tidy <-
  midnight_beds_dch_tbats_forecast %>%
  mutate(sweep = map(
    forecast.tbats,
    sw_sweep,
...
midnight_beds_dch_tbats_forecast_tidy$date_value <-
  rep(seq.Date(
...
midnight_beds_dch_tbats_forecast_tidy$`Occupied Beds`[midnight_beds_dch_tbats_forecast_tidy$`Occupied Beds` <
                                                        0] <-
  0
midnight_beds_dch_tbats_forecast_tidy$lo.80[midnight_beds_dch_tbats_forecast_tidy$lo.80 <
                                              0] <- 0
midnight_beds_dch_tbats_forecast_tidy$lo.95 [midnight_beds_dch_tbats_forecast_tidy$lo.95 <
                                               0] <- 0
